# Round 001 Brief — Inline Pack

> **For LLMs that cannot fetch external URLs.** This single document inlines
> the brief + all context docs + all code samples that round 001 references.
> The 18 screenshots cannot be inlined (they are PNG binary) — they will be
> attached separately as files (drag-and-drop in chat) or as URLs at:
...
The 18 PNG screenshots are NOT inlined in this document. They are:

| # | Filename | Description |
|---|---|---|
| 01 | `01_lane_dashboard_kanban.png` | Lane dashboard, kanban view |
| 02 | `02_lane_dashboard_list.png` | Lane dashboard, list view |
| 03 | `03_lane_dashboard_mindmap.png` | Lane dashboard, mindmap view |
| 04 | `04_lane_dashboard_filters_modal.png` | Lane dashboard with filter modal (NOTE: byte-identical to #01 due to a known iter 268 LiveView mount-state bug — `?filter_modal=people` not consumed at mount; this is an intentional "found bug" capture, not a real filter modal screenshot) |
| 05 | `05_project_index.png` | Project list (card grid + filter bar) |
| 06 | `06_project_show_with_members.png` | Project detail (members strip + task list) |
| 07 | `07_crm_contact_index.png` | CRM contact index |
| 08 | `08_crm_lead_show.png` | CRM lead surface (NOTE: fell back to lead index — no leads in dev tenant) |
| 09 | `09_person_dashboard.png` | Person dashboard demo |
| 10 | `10_orgunit_dashboard.png` | OrgUnit dashboard demo |
| 11 | `11_ageops_agents.png` | AgeOps agent grid |
| 12 | `12_handbuch.png` | Documentation browser (Leitbild/mission surface) |
| 13 | `13_personal_dashboard.png` | Personal dashboard demo (brick/widget grid) |
| 14 | `14_right_panel_compact.png` | Documentation surface (Reglemente/regulations — substituted for compact-right-panel slot since right-panel state is interaction-driven, not URL-driven; slug preserved for filename stability) |
| 15 | `15_grok_demo.png` | Grok design system showcase (USE AS GROUND TRUTH) |
| 16 | `16_megalith_map.png` | Global orientation map |
| 17 | `17_organization_grok.png` | Organization dashboard, Grok variant |
| 18 | `18_project_workspace_demo.png` | Project workspace demo (multi-pane) |

When answering, cite screenshots as `02_screenshots/NN_<slug>.png` (e.g. `02_screenshots/06_project_show_with_members.png`).
...
End of inline pack. Total length follows; if any section is truncated in your view, ask the user to repaste.
